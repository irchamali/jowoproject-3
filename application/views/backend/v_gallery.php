...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url() . 'assets/images/favponpes.png' ?>">
    <!-- Styles -->
...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="<?php echo site_url('backend/dashboard'); ?>" class="logo-text"><span>DARUL</span></a>
                </div><!-- Logo Box -->
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="<?php echo site_url('backend/testimonial'); ?>" class="waves-effect waves-button"><span class="menu-icon icon-graduation"></span>
                            <p>Teams</p>
                        </a></li>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    ...
                                                    <?php else : ?>
                                                        <img class="img-circle" width="50" src="<?php echo base_url() . 'assets/images/' . $row->gallery_image; ?>">
                                                    <?php endif; ?>
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $row->gallery_name; ?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->gallery_content; ?></td>
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->gallery_id; ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-userid="<?php echo $row->gallery_id; ?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <!-- Modal -->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/gallery/insert' ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <textarea name="content" class="form-control" rows="6" placeholder="Deskripsi" required></textarea>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify" data-height="180" data-default-file="<?php echo base_url() . 'assets/images/' . $row->gallery_image; ?>">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" name="nama" value="<?php echo $row->gallery_name; ?>" class="form-control" placeholder="Name" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="content" class="form-control" rows="6" placeholder="Content" required><?php echo $row->gallery_content; ?></textarea>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="gallery_id" value="<?php echo $row->gallery_id; ?>" required>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    <!-- Modal hapus-->
    <form id="add-row-form" action="<?php echo base_url() . 'backend/gallery/delete' ?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <strong>Anda yakin mau menghapus gallery ini?</strong>
                        <div class="form-group">
